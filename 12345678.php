...
if(isset($_GET['register'])) {
	...
	if(!$error) {	
		...
		$result = $statement->execute(array('email' => $email, 'passwort' => $passwort_hash, 'vorname' => $vorname, 'nachname' => $nachname, 'permission_level' => $permission_level));
...
<div class="form-group">
  ...
  <select id="inputPermission" name="permission_level" class="form-control" required>
